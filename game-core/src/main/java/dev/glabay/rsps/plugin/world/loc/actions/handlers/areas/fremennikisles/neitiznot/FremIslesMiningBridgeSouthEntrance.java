...
import static io.xeros.model.definition.Objects.ROPE_BRIDGE_21314;
 ...
 * @since 10/1/2024
 */
public class FremIslesMiningBridgeSouthEntrance extends WorldObjectAction {

    @Override
    public Integer[] getIds() {
        return new Integer[]{ ROPE_BRIDGE_21314 };
    }
    ...
    private Boolean EnterBridge(Player player, GlobalObject object) {
        player.getPA().movePlayer(2378, 3848, 0);
        return true;
    }
}