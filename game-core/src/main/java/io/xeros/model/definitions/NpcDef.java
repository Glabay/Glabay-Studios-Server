...
public class NpcDef {
    ...
    public static class NpcDefBuilder {
        ...
        public NpcDefBuilder name(final String name) {
            this.name = name;
            return this;
        }

        public NpcDefBuilder combatLevel(final int combatLevel) {
            this.combatLevel = combatLevel;
            return this;
        }

        public NpcDefBuilder size(final int size) {
            this.size = size;
            return this;
        }

        public NpcDefBuilder runnable(final boolean runnable) {
            this.runnable = runnable;
            return this;
        }
    ...
    public static NpcDefBuilder builder() {
        return new NpcDefBuilder();
    }
