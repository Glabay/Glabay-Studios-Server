...
public final class ItemStats {
    ...
    public static class ItemStatsBuilder {
        ...
        public ItemStatsBuilder name(final String name) {
            this.name = name;
            return this;
        }

        public ItemStatsBuilder quest(final Boolean quest) {
            this.quest = quest;
            return this;
        }

        public ItemStatsBuilder equipable(final Boolean equipable) {
            this.equipable = equipable;
            return this;
        }

        public ItemStatsBuilder weight(final Double weight) {
            this.weight = weight;
            return this;
        }

        public ItemStatsBuilder equipment(final ItemEquipmentStats equipment) {
            this.equipment = equipment;
            return this;
        }
    ...
    public static ItemStatsBuilder builder() {
