package io.xeros.model.world.objects.actions.handlers.areas.canifis;
...
public class Gap extends WorldObjectAction {
    ...
    @Override
    protected Integer[] getIds() {return new Integer[] {14845, 14848, 14846, 14894, 14847, 14897, 14844}; }
