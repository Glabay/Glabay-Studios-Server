 ...
 * @since 2024-09-16
 */
public abstract class WorldObjectAction extends ObjectAction implements  ObjectActionI,
                                                    ObjectActionOne,
                                                    ObjectActionTwo,
                                                    ObjectActionThree,
                                                    ObjectActionFour,
    ...
    public boolean performedAction(Player player, int objectId, int objectX, int objectY, int objectZ, int objectActionId) {
        ...
        // check if object exists that we click
        if (Server.getGlobalObjects().exists(objectId, objectX, objectY, objectZ)) {
